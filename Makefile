...
test_gpt2_cuda_prefix_cache: dev/cuda/test_gpt2_cuda_prefix_cache.cu mini_vllm/cuda/gpt2_cuda_model_runner.cu mini_vllm/cuda/paged_attention.cu
	$(NVCC) $(NVCC_FLAGS) -Xcompiler -fopenmp $^ $(NVCC_INCLUDES) -lcublas -lgomp -lm $(CUDA_OUTPUT_FILE)
